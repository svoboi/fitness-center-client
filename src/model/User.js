...
class User {
     ...
     */
    constructor(firstName, lastName, username, password, emailAddress, employee, customer) { 
        
        User.initialize(this, firstName, lastName, username, password, emailAddress, employee, customer);
    }
     ...
     */
    static initialize(obj, firstName, lastName, username, password, emailAddress, employee, customer) { 
...
User.RequiredProperties = ["firstName", "lastName", "username", "password", "emailAddress", "employee", "customer"];
 ...
 */
User.prototype['customer'] = undefined;
